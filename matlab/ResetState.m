% ResetState reset the position and quaternion of IMU frame
...
%
function [State] = ResetState(State, visionMeas, markerMap, cameraInfo)
% This function is very similar with the InitPositionAndQuaternion
